...
const EnhancedSellerRegister = () => {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            console.log("Mock seller registration data:", formData);
            alert("ثبت نام فروشنده با موفقیت انجام شد! (عملیات شبیه‌سازی شده)");
            navigate("/seller-profile");

        } catch (error) {
            console.error("Seller registration error (mocked):", error);
            alert("خطا در ثبت نام (شبیه‌سازی شده). لطفاً بعداً تلاش کنید.");
        } finally {
            setLoading(false);
        }
    };
            ...
            <div className="min-h-screen flex items-center justify-center bg-gray-50">
                <div className="bg-white p-8 rounded-lg shadow-lg text-center">
                    ...
                    <h2 className="text-xl font-bold text-gray-800 mb-4">
                        برای ثبت نام فروشنده ابتدا وارد حساب کاربری خود شوید (در حالت دمو، این پیام فقط برای اطلاع است)
                    </h2>
                    <button
